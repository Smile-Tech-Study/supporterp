...
Чтобы указать срок действия медицинской справки у ученика, необходимо отредактировать его профиль. На странице ученика рядом с **Основная информация** нажать на карандаш ![](<../.gitbook/assets/image (1) (1) (1) (1).png" alt="" data-size="line">
...
2. Рядом с **Основная информация** нажмите на карандаш ![](<../.gitbook/assets/image (1) (1) (1) (1).png" alt="" data-size="line"> для редактирования профиля.
3. Добавьте слово _дубль_ к имени.
4. Сохраните внесенные изменения.
5. На странице ученика внизу блока **Основная информация** нажмите ![](<../.gitbook/assets/image (106).png" alt="" data-size="line">
