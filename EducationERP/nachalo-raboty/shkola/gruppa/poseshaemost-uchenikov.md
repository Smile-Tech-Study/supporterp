...
В блоке "**Посещаемость**" на странице группы будут сгенерированы занятия по добавленному [расписанию](dobavlenie-grupp). Вы сможете [добавлять учеников](./../../../../ucheniki) в группу и ставить им отметки о посещении.
