...
{% tabs %}
{% tab title="Франчайзи" %}
Пример: франчайзи необходимо, чтобы ученики школы "Русский Балет" возраста с 6 до 14 лет прошли медицинский осмотр.&#x20;

Для отправки уведомлений на выбранный франчайзи способ рассылки(у нас это будет сообщение на телефон) клиентам присылается сообщение с направление, чтобы их ребёнок прошёл медицинский осмотр от школы.
{% endtab %}
