...
Для отправки уведомлений, на выбранный франчайзи способ рассылки, клиентам присылается сообщение с направлением, чтобы их ребёнок прошёл медицинский осмотр от школы.
{% endtab %}
