...
[Ученик](../ucheniki/) - это ребёнок, который ходит на занятия. Клиент - это взрослый человек (обычно родитель), с которым заключается договор. У Клиента может быть несколько детей - учеников.
...
После регистрации Клиента, его ребёнка приглашают на пробное занятие, поэтому Клиенту нужно добавить [Ученика](../ucheniki/).\
\
