...
Способ регистрации Анкета педагога - это человек подал заявку на работу в эту школу, но этот способ можно опустить, так как планируется переработка.
...
{% hint style="info" %}
По способу регистрации клиентов можно отсортировать, используя настраиваемый список.
{% endhint %}
