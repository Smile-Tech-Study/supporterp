...
Происходит между[ школами-партнёрами.](./../EducationERP/nachalo-raboty/shkola/partnyory)
...
**Новые заявки** появятся в разделе [**Уведомления**](./../uvedomleniya/_index) на дашборде и в главном меню.
...
По способу регистрации клиентов можно отсортировать, используя[ настраиваемый список.](nastraivaemyi-spisok-klientov)
...
Чтобы сэкономить время, настройте [интеграцию](./../integracii/_index) - автоматическую передачу заявок между сервисами.

:::

Ознакомьтесь со списком интеграций:

-  [Заявки через чат-бот Афина ](../chat-bot-afina/chto-mozhet-afina)

Автоматические сообщения чат-бота помогут привлечь новых клиентов в систему и записать их на пробное занятие.

-  [Форма сбора заявок Marquiz](./../integracii/marquiz/_index)
