...
Клиент звонит на единый номер колл-центра. В это время оператор заполняет форму с указанием школы, в которую подаётся заявка. В Education ERP также предоставляется источник заявки, то есть, откуда клиент узнал о номере колл-центра.&#x20;
