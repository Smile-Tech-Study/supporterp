...
6. Внесите в форму ниже в поле <mark style="color:blue;">**Полная ссылка на страницу школы в ВКонтакте**</mark> полную ссылку на страницу вашей школы в ВКонтакте. Пример полной ссылки: https://vk.com/testSchoolPage. Скриншоты ниже иллюстрируют действия.
